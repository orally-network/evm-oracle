...
contract Deploy_1 is Script {
    ...
    address constant amaAddress = 0xA40a0617BA2b446b0300eeD8B7D8A4C790216314;
    ...
    function run() public {
        ...
        // deploy oracles
        OrallyPriceFeed btcOracle = new OrallyPriceFeed(
            address(registry),
            8,
            "BTC/USD"
        );
        ...
        OrallyPriceFeed ethOracle = new OrallyPriceFeed(
            address(registry),
            18,
            "ETH/USD"
        );
